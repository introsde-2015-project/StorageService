 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://soap.project.introsde/", wsdlLocation = "https://localdb-introsde.herokuapp.com/ws/people?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://soap.project.introsde/", "PeopleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://localdb-introsde.herokuapp.com/ws/people?wsdl");
    ...
    public People getPeopleImplPort() {
        return super.getPort(new QName("http://soap.project.introsde/", "PeopleImplPort"), People.class);
    }
    ...
    public People getPeopleImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.project.introsde/", "PeopleImplPort"), People.class, features);
    }
